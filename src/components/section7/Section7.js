...
const logos = [
  "/assets/icons/brand1.svg",
  "/assets/icons/brand2.svg",
  "/assets/icons/brand3.svg",
  "/assets/icons/brand4.svg",
  "/assets/icons/brand5.svg",
];
          ...
          >
            ...
            >
              <InfoCard>
                <Box
                  component="img"
                  src="/assets/icons/notification-section7.svg"
                  width={50}
                />
                <Box>
            ...
            >
              <InfoCard>
                <Box component="img" src="/assets/icons/raket.svg" width={50} />
                <Box>
                  <Typography variant="h5" sx={{ fontWeight: "bold" }}>
                    Augmented Reality
                  </Typography>
